(function () {
  ...
  // let calendarInit = function (parentInput) {
  ...
  //
  //     let createElement = function (dayWeek) {
  //       let div = document.createElement('div');
  //       div.classList.add('cell');
  //       div.innerHTML = dayWeek;
  //       return div;
  //     }
  //
  //     for (let i = 0; i < arrWeek .length; i++) {
  //       day.append(createElement(arrWeek[i]));
  //     }
  //
  //   }
  //
  ...
  //     table += '<div class="cell">' + d.getDate() + '</div>';
  //
  ...
  //   let inputsDate = document.querySelectorAll('.form-date__input');
  //
  //   for (let input of inputsDate) {
  //     input.onfocus = function () {
  //       let parentEl = input.closest('.form-date');
  //
